...
public class NameServer implements Runnable{
    ...
    private void addNodeToMap(String name, String ip) throws IOException {
        BufferedWriter writer = new BufferedWriter(
                new FileWriter("example\\NodeMap.txt", true)  //Set true for append mode
        );
    ...
    private void removeNodeFromMap(Integer node) throws IOException {
        nodes.clear();
        File file = new File("example\\NodeMap.txt");
        ...
        int i = 0;
        BufferedWriter writer = new BufferedWriter(
                new FileWriter("example\\NodeMap.txt", false)  //Set true for append mode
        );
    ...
    private void readDatabase() throws IOException {
        File file2 = new File("example\\Database2.txt");
