...
public class NameServer implements Runnable{
    ...
    private void addNodeToMap(String name, String ip) throws IOException {
        BufferedWriter writer = new BufferedWriter(
                new FileWriter("com//example//backLogic//NodeMap.txt", true)  //Set true for append mode
        );
    ...
    private void removeNodeFromMap(Integer node) throws IOException {
        nodes.clear();
        File file = new File("com//example//backLogic//NodeMap.txt");
        ...
        int i = 0;
        BufferedWriter writer = new BufferedWriter(
                new FileWriter("com//example//backLogic//NodeMap.txt", false)  //Set true for append mode
        );
    ...
    private void readDatabase() throws IOException {
        File file2 = new File("com//backLogic//example//Database2.txt");
